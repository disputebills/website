...
<header class="page-header">
  <div class="header-text">
    ...
    <ul class="header-links">
      <li><a href="https://app.disputebills.com/pricing/" class="button-white-base">Start my dispute</a></li>
  ...
  <div class="features-container">
    ...
    <ul class="features-list">
      ...
      <?php endif; // */ ?>
          ...
          <li class="feature-li-0">
              <i class="fa fa-user service-icon"></i>
              <div class="feature-text">
                <h5>Experienced Advocates</h5>
                <p>Our medical bill advocates represent over 200 years of combined patient billing, customer service, and insurance verification experience.</p>
            </div>
          </li>

          <li class="feature-li-1">
          ...
          <li class="feature-li-2">
              <i class="fa fa-search service-icon"></i>
              <div class="feature-text">
                <h5>We Do All the Research</h5>
                <p>Sit back and save. Your advocate conducts all medical bill review and negotiations on your behalf and updates you in real-time.</p>
            </div>
          </li>

          <li class="feature-li-3">
...
srcset="
http://res.cloudinary.com/lonesome-highway/image/upload/f_auto,q_70,w_200/v1460642309/medical-billing-software.png 200w,
http://res.cloudinary.com/lonesome-highway/image/upload/f_auto,q_70,w_360/v1460642309/medical-billing-software.png 360w,
http://res.cloudinary.com/lonesome-highway/image/upload/f_auto,q_70,w_483/v1460642309/medical-billing-software.png 483w,
http://res.cloudinary.com/lonesome-highway/image/upload/f_auto,q_70,w_554/v1460642309/medical-billing-software.png 554w"
src="http://res.cloudinary.com/lonesome-highway/image/upload/f_auto,q_70,w_360/v1460642309/medical-billing-software.png"
