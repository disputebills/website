/*! Vendor Scripts: jquery@1.12.4,jquery.migrate@1.4.1,modernizr@2.8.3,detectizr@2.2.0,jquery.flexnav@1.3.3,jquery.hoverintent@r7 */
...
/*! Jquery Equalizer for Yuzo Related Posts */
...
/*! Mobile Nav */
jQuery(document).ready(function(e){e(".sliding-panel-button,.sliding-panel-fade-screen,.sliding-panel-close").on("click touchstart",function(n){e(".sliding-panel-content,.sliding-panel-fade-screen").toggleClass("is-visible"),n.preventDefault()}),e(".flexnav").flexNav({animationSpeed:250,transitionOpacity:!0,buttonSelector:".menu-button",hoverIntent:!0,hoverIntentTimeout:350,calcItemWidths:!1})});